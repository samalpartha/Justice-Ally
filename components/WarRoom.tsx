...
const WarRoom: React.FC<WarRoomProps> = ({ caseData, onFilesAdded, onLinkAdded, onNotesChange, onLoadDemo }) => {
  ...
  const handleExportPdf = () => {
      alert("PDF Export Generated. (Simulation)");
  };

  const EmptyState = () => (
    <div className="h-full flex flex-col items-center justify-center p-8 text-center bg-slate-950 transition-colors duration-300">
  ...
  return (
    <div className="h-full flex flex-col overflow-hidden relative bg-slate-950 transition-colors duration-300">
      {/* Strategy Header */}
      <div className="shrink-0 px-8 py-6 border-b-2 border-slate-800 bg-slate-950 shadow-xl z-10 flex justify-between items-center transition-colors duration-300">
        <div>
          <h1 className="text-2xl font-serif font-black text-slate-100 flex items-center gap-3 tracking-tight transition-colors duration-300">
             {t('warroom', 'header')}
          </h1>
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar p-8">
        <div className="max-w-[1600px] mx-auto space-y-8">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-sm shadow-lg relative overflow-hidden group transition-colors duration-300">
            <div className="bg-slate-900 px-6 py-3 border-b border-slate-800 flex justify-between items-center transition-colors duration-300">
               ...
               <div className="flex items-center gap-3">
                   {caseData && (
                        <button onClick={handleExportPdf} className="text-[10px] font-bold uppercase text-slate-500 hover:text-slate-200 flex items-center gap-1 transition-colors">
            ...
            <textarea
              ...
              className="w-full bg-slate-950 text-slate-200 text-sm p-6 outline-none min-h-[120px] resize-none font-serif leading-7 transition-colors duration-300"
            />
            {/* Save Entry Button */}
            <div className="px-6 pb-4 bg-slate-950 border-t border-slate-800 flex justify-between items-center transition-colors duration-300">
          ...
          {!caseData || !caseData.strategy ? (
            ...
            <>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 bg-slate-900 rounded-sm border-l-4 border-amber-600 p-8 shadow-md relative overflow-hidden transition-colors duration-300">
                   ...
                   <h3 className="text-3xl font-serif font-black text-slate-100 mb-6 tracking-tight transition-colors duration-300">"{caseData.strategy.sunTzu.strategyName}"</h3>
                ...
                <div className="bg-slate-900 rounded-sm border border-slate-800 p-6 shadow-md flex flex-col transition-colors duration-300">
              ...
              <div className="bg-slate-900 rounded-sm border border-slate-800 shadow-md overflow-hidden transition-colors duration-300">
                <div className="px-6 py-4 border-b border-slate-800 bg-slate-950 flex justify-between items-center transition-colors duration-300">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-slate-900 rounded-sm border border-slate-800 p-6 shadow-md transition-colors duration-300">
                  <h3 className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-4 flex items-center gap-2 border-b border-slate-800 pb-2">
