      ...
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <div className="text-center space-y-6 border-b-2 border-slate-800 pb-12">
          ...
          <div>
             ...
             <p className="text-amber-600 font-bold uppercase tracking-[0.3em] text-xs">{t('help', 'subtitle')}</p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {[
            ...
            { id: "04", title: t('sidebar', 'tacticalChat'), desc: "Draft motions and research case law via AI co-counsel." }
          ].map((item) => (
