      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        <div className="relative max-w-2xl mx-auto">
           <input 
             ...
             className="w-full bg-slate-900 border border-slate-700 rounded-sm py-3 px-6 pl-12 text-sm text-slate-200 focus:border-amber-600 outline-none shadow-lg placeholder:text-slate-600 font-serif"
           />
