      ...
      <aside className="w-72 bg-slate-950 border-r-4 border-double border-slate-800 flex flex-col shrink-0 z-20 shadow-[4px_0_24px_rgba(0,0,0,0.5)]">
        ...
        <div className="p-8 border-b border-slate-800 bg-slate-950 relative">
          <div className="flex items-center gap-4">
             <div className="w-10 h-10 flex items-center justify-center border-2 border-amber-700 rounded-sm bg-slate-900 shadow-inner">
             ...
             <div>
               <h1 className="font-serif font-black text-xl text-slate-100 tracking-tight leading-none">JUSTICE<span className="text-amber-600">ALLY</span></h1>
               <p className="text-[9px] text-slate-500 uppercase tracking-[0.2em] font-bold mt-1">Legal Navigator</p>
             </div>
          </div>
        </div>
          ...
          <div className="px-6 py-4 bg-slate-900/50 border-b border-slate-800 flex items-center gap-3">
             ...
             <div className="flex-1 min-w-0">
                ...
                <p className={`text-[9px] uppercase tracking-widest font-bold ${user.role === 'attorney' ? 'text-blue-500' : 'text-amber-600'}`}>
                   {user.role === 'attorney' ? 'Attorney at Law' : 'Self-Represented Litigant'}
                </p>
             </div>
             <button onClick={onLogout} title="Sign Out" className="text-slate-500 hover:text-white">
        ...
        <nav className="flex-1 overflow-y-auto py-4 custom-scrollbar">
          <div className="px-6 mb-2">
            <p className="text-[10px] font-bold text-slate-600 uppercase tracking-widest border-b border-slate-800 pb-1 mb-2">Case Intake</p>
          </div>
          <NavItem 
            mode={AppMode.TRIAGE} 
          ...
          <div className="px-6 mt-6 mb-2">
            <p className="text-[10px] font-bold text-slate-600 uppercase tracking-widest border-b border-slate-800 pb-1 mb-2">Case Management</p>
          </div>
          <NavItem 
          ...
          <div className="px-6 mt-6 mb-2">
            <p className="text-[10px] font-bold text-slate-600 uppercase tracking-widest border-b border-slate-800 pb-1 mb-2">Counsel & Tools</p>
          </div>
          <NavItem 
            mode={AppMode.CHAT} 
        ...
        <div className="p-6 border-t border-slate-800 bg-slate-900/50">
          <div className="grid grid-cols-2 gap-2 mb-4">
             ...
             <button onClick={onLoad} className="flex flex-col items-center justify-center p-2 bg-slate-900 border border-slate-700 hover:border-amber-600 rounded-sm text-slate-400 hover:text-amber-500 transition-all group">
               ...
               <span className="text-[9px] font-bold uppercase tracking-wider">Load</span>
             </button>
          </div>
          <button 
          ...
          >
             ...
             <span className="text-[10px] font-bold uppercase tracking-widest">System Protocols</span>
          </button>
