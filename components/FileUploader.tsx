    ...
    <div className="w-full space-y-6">
      ...
      <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-slate-800 border-dashed rounded-sm cursor-pointer bg-slate-950 hover:bg-slate-900 hover:border-amber-600 transition-all group" title="Drag and drop or click to select files. Supports PDF, Images, and Video.">
        <div className="flex flex-col items-center justify-center pt-5 pb-6">
          ...
          <p className="mb-1 text-sm text-slate-400 font-serif"><span className="font-bold text-slate-200 group-hover:text-amber-500">Click to upload</span> or drag evidence</p>
          <p className="text-[10px] text-slate-600 uppercase tracking-widest font-bold">PDF • PNG • JPG • MP4</p>
        </div>
        <input 
          type="file" 
          className="hidden" 
      ...
      <div className="flex items-center gap-4">
        ...
        <span className="text-[9px] text-slate-600 uppercase font-bold tracking-widest">OR Add Citation</span>
        <div className="h-px bg-slate-800 flex-1"></div>
      </div>
